...
#define STR(r) case VK_FORMAT_##r: return #r
			...
			STR(ASTC_4x4_SFLOAT_BLOCK_EXT);
			STR(ASTC_5x4_SFLOAT_BLOCK_EXT);
			STR(ASTC_5x5_SFLOAT_BLOCK_EXT);
			STR(ASTC_6x5_SFLOAT_BLOCK_EXT);
			STR(ASTC_6x6_SFLOAT_BLOCK_EXT);
			STR(ASTC_8x5_SFLOAT_BLOCK_EXT);
			STR(ASTC_8x6_SFLOAT_BLOCK_EXT);
			STR(ASTC_8x8_SFLOAT_BLOCK_EXT);
			STR(ASTC_10x5_SFLOAT_BLOCK_EXT);
			STR(ASTC_10x6_SFLOAT_BLOCK_EXT);
			STR(ASTC_10x8_SFLOAT_BLOCK_EXT);
			STR(ASTC_10x10_SFLOAT_BLOCK_EXT);
			STR(ASTC_12x10_SFLOAT_BLOCK_EXT);
			STR(ASTC_12x12_SFLOAT_BLOCK_EXT);
#undef STR
